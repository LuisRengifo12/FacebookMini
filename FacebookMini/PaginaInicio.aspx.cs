...
namespace FacebookMini
{
    public partial class PaginaInicio : System.Web.UI.Page
    {
        ...
        private void MostrarPublicaciones()
        {
            ...
            using (FacebookBD.Modelo.FBUSARIOSEntities contexto = new FacebookBD.Modelo.FBUSARIOSEntities())
            {
        ...
        {
            using (FBUSARIOSEntities db = new FBUSARIOSEntities())
            {
        ...
        protected void btnCrearPublicacion_Click(object sender, EventArgs e)
        {
            ...
            if (archivo != null && archivo.ContentLength > 0)
            {
                ...
                {
                    using (var db = new FBUSARIOSEntities())
                    {
